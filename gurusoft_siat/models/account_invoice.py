            ...
            if inv.token_id:
                ...
                if inv.estado_siat == 'VALIDA':
                    ...
                    response = requests.post(
                        'https://labbo-emp-operaciones-v2-1.guru-soft.com/api/Operaciones/AnulaDocumento',
                        headers=headers,
                        data=json_invoice)
                    if response.ok:
            ...
            if inv.token_id:
                if inv.estado_siat == 'VALIDA':
                    ...
                    response = requests.get(
                        'https://labbo-emp-consulta-v2-1.guru-soft.com/api/Consultar/ConsultaDocumento',
        ...
        for inv in self:
            ...
            if inv.token_id:
                ...
                if inv.type in ('out_invoice'):
                    ...
                    total_descuento = round(inv.amount_discount * 6.97, 2)
                    ...
                    for lines in inv.invoice_line_ids:
                        ...
                        price_unit = round(price_unit_desc * 6.97, 2)

                        price_unit_sin = round(lines.price_unit * 6.97, 2)
                    ...
                    response = requests.post(
                        'https://labbo-emp-emision-v2-1.guru-soft.com/api/Emitir/EmisionFacturaCompraVenta',
                        headers=headers,
                        data=json_invoice)
                    # print response.text
                    if response.ok:
                    ...
                    pprint.pprint(json_invoice)
                    response = requests.post(
                        'https://labbo-emp-emision-v2-1.guru-soft.com/api/Emitir/EmisionNotaCreditoDebito',
                        headers=headers,
                        data=json_invoice)
                    print response.text
                    if response.ok:
