...
class GurusoftToken(models.Model):
    ...
    def get_token(self):
        ...
        r = requests.get("https://labbo-emp-auth-v2-1.guru-soft.com/ServicioEDOC/?id=1",
                         headers={"Authorization": "Basic %s" % b64Val},
                         data=[])
        data = json.loads(r.content)
        self.token_factura = str(data['token'])

        r2 = requests.get("https://labbo-emp-auth-v2-1.guru-soft.com/ServicioEDOC/?id=3",
                          headers={"Authorization": "Basic %s" % b64Val},
                          data=[])
        data2 = json.loads(r2.content)
        self.token_catalogo = str(data2['token'])

        r3 = requests.get("https://labbo-emp-auth-v2-1.guru-soft.com/ServicioEDOC/?id=5",
                          headers={"Authorization": "Basic %s" % b64Val},
                          data=[])
    ...
    def sincronizar_catalogo(self):
        ...
        response = requests.get('https://labbo-emp-consulta-v2-1.guru-soft.com/api/Consultar/ConsultarCatalogoGeneral',
        ...
        response = requests.get(
            'https://labbo-emp-consulta-v2-1.guru-soft.com/api/Consultar/ConsultarCatalogoGeneral',
            headers=headers, params=params)
