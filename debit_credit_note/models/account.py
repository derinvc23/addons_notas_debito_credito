...
class AccountJournal(models.Model):
    ...
    debit_note_sequence_id = fields.Many2one('ir.sequence', string='Secuencia de entrada de notas de debito',
                                         help="This field contains the information related to the numbering of the debit note entries of this journal.",
                                         copy=False)

    debit_note_sequence = fields.Boolean(string='Secuencia de nota de debito dedicada',
